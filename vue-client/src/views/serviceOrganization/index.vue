  ...
  <div class="my-dashboard-container">
    ...
    >
      ...
      >
        ...
        <el-table-column label="机构名称" align="left" prop="title" width="300">
          <template slot-scope="scope">
            <el-button type="text" style="color: #215DA9" @click="toServiceOrgDetail(scope.row)">
              {{ scope.row.properties.agencyName?scope.row.properties.agencyName:scope.row.properties.name }}
            </el-button>
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    async onSearchMap() {
      ...
      myGeoChart.on('click', async function(params) {
        _this.unitAddress = params.name
        this.unitAddress = _this.unitAddress
        _this.table = true
