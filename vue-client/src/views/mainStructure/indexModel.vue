        ...
        <el-container>
          <el-main style="padding:0;">
            <el-card shadow="hover">
              ...
              <el-row type="flex" style="margin-top: 20px;line-height:60px;font-weight:500;font-size:15px;font-family: Avenir, Helvetica, Arial, sans-serif;" justify="center">
                <el-col :span="8">
                  <span>模块类别：</span>
                </el-col>
                <el-col :span="20">
              ...
              <el-row type="flex" justify="center">
                <el-col :span="24">
                  <el-input v-model="property" placeholder="请输入主模型特性" prefix-icon="el-icon-search" class="input-with-select">
                    <el-autocomplete
                      slot="prepend"
                      v-model="label"
                    ...
                    />
                    <el-input-number slot="append" v-model="num" :min="1" :max="10" controls-position="right" size="small" />
                  </el-input>
                </el-col>
                <el-col :span="4" style="margin-left: 20px">
                  <el-button type="primary" icon="el-icon-search" circle plain @click="onSubmitEntity" />
                </el-col>
              </el-row>
...
export default {
  ...
  methods: {
    ...
    //     var data = res.data.data
    //     console.log('主结构：：', data)
    //     if (res.data.code === 20000) {
    //       this.configLabel = []
    //       data.nodes.forEach(node => {
    //         var labelObj = {}
    //         labelObj['value'] = node.properties.name
    //         labelObj['label'] = node.labels[0]
